...
static const char *fonts[] = {"DejaVuSansMono Nerd Font",
...
static const char *colors[][3] = {
    ...
    [SchemeSel] = {col_gray3, col_gray1, col_brightpurple},
};
...
static const Rule rules[] = {
    ...
    {"Ulauncher", NULL, NULL, 0, 1, -1}, {"ulauncher", NULL, "", 0, 1, -1},
...
static const Layout layouts[] = {
    ...
    {"[M]", monocle}, {"|M|", centeredmaster}, {"#G#", horizgrid},
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_grave, quit, {0}},
};
